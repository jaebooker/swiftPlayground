...
func square(height: Int, width: Int) -> Int{
    var param = (height + width) * 2
    return param
}
func irr(info: [Int]) -> Int{
    var sum = 0
    for i in info {
        sum += i
    }
...
func instructor(name: String) -> [String] {
    var newInstructors: [String] = []
    //for i in instructors {
    // if i.hasPrefix(name) {
    //    newInstructors.append(i)
    //}
