...
/*: 
 ...
 The cool thing about protocols is that you only declare the signatures of methods in a protocol. Protocols never contain body (code) of any methods they declare. So these challenges will be easier than they look. 
...
protocol TableViewDataSouce {
    func numberOfCells() -> Int
    func numberOfSection() -> Int
}
protocol Posting {
    func post()
    func postTest(text: String)
