...
var lastItem = mutableGroceryList[mutableGroceryList.count - 1]
print(lastItem)
/*:
...
*/
var farmLife: [String] = ["Wake Up", "Wash the dishes", "Milk dem cows"]
farmLife.append("Churn butter")
farmLife += ["Call dem cows","Shear em sheeple"]
print(farmLife[0])
var currentTask: Int = 0
print(farmLife[currentTask])
currentTask += 1
print(farmLife[currentTask])
farmLife.insert("feed dem hens", at: 2)
currentTask += 1
print(farmLife[currentTask])
print(farmLife)
