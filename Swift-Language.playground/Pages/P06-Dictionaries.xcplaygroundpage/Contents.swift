...
instructors = ["Jack": "Kirby"]
instructors = ["Jason": "Bourne"]
print(instructors["Jack"]!)
if instructors["Jacky"] != nil {
    print(instructors["Jacky"]!)
} else {
    print("Yo, Jacky! Where you at?")
}
var track: [String: [String]] = [:]
track["hacking"] = ["Snowden", "Assange", "Whoever made bitcoin"]
track["heckling"] = ["Louis CK", "Donald", "Chris Rock"]


if let hackers = track["hacking"] {
    print("I'm hacking \(hackers)")
} else {
    print("I don't know who I am or what I'm doing! Help! I've fallen and I can't get up!")
}
